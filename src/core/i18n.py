...
def t_col(col_name, lang="ar"):
    ...
    # 3. Fallback for specific partials
    if "financial obligations" in col_str.lower(): return "هل لديك التزامات مالية؟"
    if "contract end" in col_str.lower(): return "تاريخ انتهاء العقد"
    if "mobile" in col_str.lower(): return "رقم الجوال"
    if "phone" in col_str.lower(): return "رقم الهاتف"
