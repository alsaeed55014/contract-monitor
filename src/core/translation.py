...
class TranslationManager:
    def __init__(self):
        ...
        self.dictionary = {
            ...
            "المنطقة الوسطى": ["Central", "Riyadh", "Al-Kharj", "Al Majma'ah", "Zulfi", "Wadi ad-Dawasir"],
            "المنطقة الغربية": ["Western", "Jeddah", "Makkah", "Madinah", "Taif", "Yanbu", "Rabigh", "Al Lith", "Al Qunfudhah"],
            "الوسطى": ["Central", "Riyadh", "Al-Kharj", "Al Majma'ah", "Zulfi"],
            "القصيم": ["Qassim", "Buraydah", "Unaizah", "Ar Rass", "Al Qassim", "AL QASSIM"],
