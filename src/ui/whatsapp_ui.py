...
def render_whatsapp_page():
    ...
    # 2. QR Code (Stable Mode for Pasha)
    if status == "Awaiting Login":
        st.markdown('<div style="text-align:center; padding:20px; background:white; border-radius:15px; margin-bottom:15px; border:2px solid #EEE;">', unsafe_allow_html=True)
