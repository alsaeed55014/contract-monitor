        ...
        try:
            ...
            if hasattr(st, "secrets") and "gcp_service_account" in st.secrets:
                try:
                    ...
                    print(f"[ERROR] Secrets login failed: {e}")
            ...
            if os.path.exists(creds_file):
                try:
                    ...
                    print("[DEBUG] Connected via credentials.json")
                    return
                except Exception as e:
                    print(f"[ERROR] credentials.json login failed: {e}")
                    self._error_msg = str(e)
            else:
                print("[ERROR] No credentials found.")
                self._error_msg = "Credentials file not found and no Secrets active."
                
        except Exception as e:
            print(f"[ERROR] Global Connection Error: {e}")
            self._error_msg = str(e)
